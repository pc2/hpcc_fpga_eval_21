...
#SBATCH -n 1
#SBATCH -t 2:00:00
#SBATCH -o stream_N1-%j.out
#SBATCH -e stream_N1-%j.out
#
##
#
...
srun ../../synthesis_artifacts/STREAM/520n-21.2.0-20.4.0/STREAM_FPGA_intel -f ../../synthesis_artifacts/STREAM/520n-21.2.0-20.4.0/stream_kernels_single.aocx -r 4 -s 1073741824 --device 0
