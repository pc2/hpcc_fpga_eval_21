...
#SBATCH -n 1
#SBATCH -t 2:00:00
#SBATCH -o gemm_N1-%j.out
#SBATCH -e gemm_N1-%j.out
#
##
#
...
srun ../../synthesis_artifacts/GEMM/520n-21.2.0-20.4.0/GEMM_intel -f ../../synthesis_artifacts/GEMM/520n-21.2.0-20.4.0/gemm_base.aocx -r 5 -b 512 -m 45 --device 0
