...
mpirun -n 1 -H alveo3b ../../../synthesis_artifacts/PTRANS/u280-2020.2-xdma-201920-3/Transpose_xilinx -f ../../../synthesis_artifacts/PTRANS/u280-2020.2-xdma-201920-3/transpose_PQ_PCIE.xclbin -n 10 -m 120 --device 0 | tee ptrans_N1.out
