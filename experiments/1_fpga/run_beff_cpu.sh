...
#SBATCH -t 2:00:00
#SBATCH -o beff_cpu_N1-%j.txt
#SBATCH -e beff_cpu_N1-%j.txt
#
##
#
...
srun ../../synthesis_artifacts/b_eff/520n-21.2.0-20.4.0-iec/Network_intel -f ../../synthesis_artifacts/b_eff/520n-21.2.0-20.4.0-iec/communication_bw520n_IEC.aocx --comm-type CPU -r 2 --device 0
