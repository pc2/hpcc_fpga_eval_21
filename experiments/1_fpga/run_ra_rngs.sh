...
#SBATCH -n 1
#SBATCH -t 2:00:00
#SBATCH -o ra_N1-%j.out
#SBATCH -e ra_N1-%j.out
#
##
#
...
srun ../../synthesis_artifacts/RandomAccess/520n-21.2.0-20.4.0/RandomAccess_intel -f ../../synthesis_artifacts/RandomAccess/520n-21.2.0-20.4.0/random_access_kernels_single.aocx -r 4 -d 30 --device 0
